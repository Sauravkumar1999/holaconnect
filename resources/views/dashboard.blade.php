...
@section('title', 'Dashboard - Hola Taxi Ireland')
...
@section('content')
    ...
    <div class="user-info">
        <h3><i class="fas fa-user-circle"></i> Welcome, {{ Auth::user()->name }}!</h3>
            ...
            <div class="info-item">
                ...
                <p>
                    @if(Auth::user()->document_dashboard_path)
                        <a href="{{ asset(Auth::user()->document_dashboard_path) }}" target="_blank" style="color: #667eea;">
            ...
            <div class="info-item">
                ...
                <p>
                    @if(Auth::user()->document_identity_path)
                        <a href="{{ asset(Auth::user()->document_identity_path) }}" target="_blank" style="color: #667eea;">
                            <i class="fas fa-download"></i> View Document
                        </a>
                    @else
                        <span style="color: #94a3b8;">Not uploaded</span>
